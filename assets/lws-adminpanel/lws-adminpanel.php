...
$lws_adminpanel = new LWS_Adminpanel(__FILE__, function()
{
	...
	class LWS_Adminpanel_Impl
	{
		...
		{
			/* Styles */
			wp_register_style('lws-checkbox', LWS_ADMIN_PANEL_CSS . '/controls/checkbox.css', array(), LWS_ADMIN_PANEL_VERSION );
			...
			/** assets */
			wp_register_script('lws-chart-js', LWS_ADMIN_PANEL_JS . '/chart.js/Chart.min.js', array(), '2.7.2', true );
		}
